...
public struct EndpointConfigurator: SessionBuilder {
    ...
    public func call<T: Decodable & Sendable>(decoder: JSONDecoder = JSONDecoder(), isDataWrapped: Bool = true, keyDecodingStrategy: JSONDecoder.KeyDecodingStrategy = .useDefaultKeys) async throws -> T {
